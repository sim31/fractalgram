...
import AccountPromptModal from '../middle/composer/AccountPromptModal';
...
import FractalResultModal from '../middle/composer/FractalResultModal';
import InlineBotTooltip from '../middle/composer/InlineBotTooltip.async';
import LoadingModal from '../middle/composer/LoadingModal';
...
const Composer: FC<OwnProps & StateProps> = ({
  ...
  const {
    ...
    () => getAllowedAttachmentOptions(chat, isChatWithBot, isInStoryViewer, fullChatInfo),
    [chat, isChatWithBot, isInStoryViewer, fullChatInfo],
  );
  ...
  const handlePollSend = useLastCallback((poll: ApiNewPoll, pinned: boolean) => {
    ...
    if (shouldSchedule) {
      ...
      if (pinned) {
        sendPinnedMessage({ messageList: currentMessageList, poll });
      } else {
...
export default memo(withGlobal<OwnProps>(
  (global, {
    ...
    const fullChatInfo = selectChatFullInfo(global, chatId);
